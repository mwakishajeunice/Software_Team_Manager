				...
				<div class="card-body p-0">
					...
					<table class="table table-condensed m-0 table-hover">
						...
						<tbody>
							<?php 
							$i = 1;
							$tasks = $conn->query("SELECT task_list.*, concat(firstname, ' ', lastname) as developer FROM task_list left join users on task_list.user_id = users.id where project_id = {$id} order by task asc");
						...
						<td class=""><b><?php echo ucwords($row['developer']) ?></b></td>
